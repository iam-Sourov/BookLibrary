    ...
    <section className="relative w-full overflow-hidden py-10 md:py-20 bg-background/50">
      ...
      <div className="relative flex w-full flex-col gap-8 md:gap-12">
        <div className="relative z-10 hover:z-20">
          <Marquee pauseOnHover className="[--duration:200s] md:[--duration:250s]">
            {books.map((book, idx) => (
              <div key={idx} className="mx-4 md:mx-6 cursor-pointer py-4">
                <BookCard book={book} />
              </div>
            ))}
          </Marquee>
        ...
        <div className="relative z-10 hover:z-20">
          <Marquee pauseOnHover reverse className="[--duration:200s] md:[--duration:250s]">
            {books.map((book, idx) => (
              <div key={`${idx}-reverse`} className="mx-4 md:mx-6 cursor-pointer py-4">
                <BookCard book={book} />
              </div>
            ))}
          </Marquee>
